...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      <div className="bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 pt-32 pb-8 relative">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          {/* Floating Emojis */}
          <div className="absolute top-32 right-[5%] text-4xl opacity-20 animate-bounceSlow">🌟</div>
          <div className="absolute top-60 left-[8%] text-3xl opacity-15 animate-float">✨</div>
          <div className="absolute bottom-60 right-[12%] text-4xl opacity-10 animate-bounceSlow animation-delay-700">🎈</div>
          
          {/* Gradient Circles */}
          <div className="absolute -top-20 -right-20 w-60 h-60 bg-pink-500/20 rounded-full blur-3xl"></div>
                ...
                <form className="flex flex-col sm:flex-row gap-3">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-4 rounded-xl bg-white text-slate-800 placeholder:text-slate-400 font-medium focus:outline-none focus:ring-4 focus:ring-pink-300 transition-all"
                    />
                  </div>
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-pink-500 to-orange-400 text-white rounded-xl font-bold shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 hover:scale-105"
                  >
                    Subscribe
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
            ...
            <div className="lg:col-span-1">
              ...
              <Link href="/" className="inline-flex items-center gap-3 mb-6 group">
                <div className="w-14 h-14 rounded-2xl bg-white/20 flex items-center justify-center text-2xl group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300 shadow-lg">
                  ⭐
                </div>
                <div>
                  ...
                  <span className="text-white/60 text-sm">Kids Therapy ✨</span>
                </div>
              </Link>
              ...
              <div className="flex gap-3">
                {socialLinks.map((social, i) => (
                  <a
                    ...
                    className={`
                      w-11 h-11 rounded-xl bg-white/10 flex items-center justify-center
                      text-white/80 transition-all duration-300
                      hover:text-white hover:scale-110 hover:-translate-y-1 hover:shadow-lg
                      ${social.color}
                    `}
                  >
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <a
                    ...
                    className="group flex items-start gap-3 text-white/70 hover:text-white transition-colors"
                  >
                    ...
                    <div>
                      <span className="block text-xs text-white/50 mb-0.5">Call Us</span>
                ...
                <li>
                  ...
                  >
                    ...
                    <div>
                      <span className="block text-xs text-white/50 mb-0.5">Email Us</span>
                ...
                <li>
                  <div className="flex items-start gap-3 text-white/70">
                    ...
                    <div>
                      <span className="block text-xs text-white/50 mb-0.5">Visit Us</span>
                ...
                <li>
                  <div className="flex items-start gap-3 text-white/70">
                    ...
                    <div>
                      <span className="block text-xs text-white/50 mb-0.5">Working Hours</span>
          ...
          <div className="border-t border-white/20 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <p className="text-white/60 text-sm flex items-center gap-2">
                ...
                <Heart className="w-4 h-4 text-pink-400 fill-current animate-heartbeat hidden sm:inline" />
